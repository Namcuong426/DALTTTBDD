...
class AppTheme{
  static Color lightBackgoundColor = const Color(0xfff2f2f2);
  ...
  static final lightTheme = ThemeData(
    ...
    textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(foregroundColor: lightBackgoundColor)
    )
  );
  ...
  static setStatusBarAndNavigationColors(ThemeMode themeMode){
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
      statusBarColor: Colors.transparent,
      statusBarIconBrightness: Brightness.light,
      systemNavigationBarIconBrightness: Brightness.light,
      systemNavigationBarColor: lightBackgoundColor,
